...
public class InformesDAO extends BaseDAO {
    ...
    // 1. Reporte completo de un paciente por cédula
    public String reportePaciente(String cedula) {
        ...
        try (Connection con = getConexion()) {
            ...
            if (rs.next()) {
                ...
                sb.append("FECHA NAC:       ")
                  .append(rs.getString("FechaNacimiento") != null
                      ? rs.getString("FechaNacimiento") : "N/A").append("\n");

                sb.append("TIPO SANGRE:     ")
                  .append(rs.getString("TipoSangre") != null
                      ? rs.getString("TipoSangre") : "N/A").append("\n");

                sb.append("INFO EMERGENCIA: ")
                  .append(rs.getString("Informacion") != null
                      ? rs.getString("Informacion") : "N/A").append("\n");

                sb.append("VIVIENDA:        ")
                  .append(rs.getString("Direccion") != null
            ...
            while (rs2.next()) {
                ...
                sb.append("  Medico:      ")
                  .append(rs2.getString("NombreMedico"))
                  .append(" (").append(rs2.getString("Especialidad")).append(")\n");

                sb.append("  Diagnostico: ")
                  .append(rs2.getString("Diagnostico") != null
                      ? rs2.getString("Diagnostico") : "N/A").append("\n");

                // Obtener enfermedades de la consulta
                ...
                while (rs3.next()) {
                    sb.append(rs3.getString("NombreEnfermedad"))
                      .append(" [")
                      .append(rs3.getString("Gravedad") != null
                          ? rs3.getString("Gravedad") : "sin clasificar")
                      .append("] ");
                    hayEnf = true;
                }
    ...
    // 2. Consultas por rango de fechas agrupadas por médico
    ...
    // 3. Ranking de médicos más activos
    ...
    // 4. Enfermedades más diagnosticadas
            ...
            while (rs.next()) {
                lista.add(new String[]{
                    ...
                    rs.getString("Gravedad") != null
                        ? rs.getString("Gravedad") : "Sin clasificar",
