...
public class VacunaDAO extends BaseDAO {
    ...
    public boolean insertar(Vacuna v) {
        return ejecutar(
            "INSERT INTO VACUNA (Id_Vacuna,NombreVacuna,Descripcion) VALUES (?,?,?)",
            v.getIdVacuna(),
            v.getNombreVacuna(),
            v.getDescripcion()
        );
    ...
    public ArrayList<Vacuna> listarTodos() {
        ...
        try (Connection con = getConexion();
             ...
             ResultSet rs = st.executeQuery(
                 "SELECT Id_Vacuna,NombreVacuna,Descripcion FROM VACUNA ORDER BY NombreVacuna")) {
            ...
            System.out.println("Error VacunaDAO: " + e.getMessage());
        }
    ...
    public boolean actualizar(Vacuna v) {
        return ejecutar(
            "UPDATE VACUNA SET NombreVacuna=?,Descripcion=? WHERE Id_Vacuna=?",
            v.getNombreVacuna(),
            v.getDescripcion(),
            v.getIdVacuna()
        );
    ...
    public boolean eliminar(String id) {
        return ejecutar(
            "DELETE FROM VACUNA WHERE Id_Vacuna=?",
            id
        );
    }
}