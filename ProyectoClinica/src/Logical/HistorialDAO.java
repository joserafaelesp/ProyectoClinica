...
public class HistorialDAO extends BaseDAO {
    public boolean insertar(String idHistorial, String cedula) {
        return ejecutar("INSERT INTO HISTORIAL_MEDICO (Id_Historial,cedula) VALUES (?,?)", idHistorial, cedula);
    }
    ...
    public boolean eliminar(String id) { return ejecutar("DELETE FROM HISTORIAL_MEDICO WHERE Id_Historial=?", id); }
}