...
public class HistorialDAO extends BaseDAO {
    ...
    public boolean insertar(String idHistorial, String cedula) {
        return ejecutar(
            "INSERT INTO HISTORIAL_MEDICO (Id_Historial,cedula) VALUES (?,?)",
            idHistorial,
            cedula
        );
    }
    ...
    public String buscarPorPaciente(String cedula) {
        ...
        try (
            ...
            try (ResultSet rs = ps.executeQuery()) {
                ...
                if (rs.next()) {
                    return rs.getString("Id_Historial");
                }
            }

        } catch (SQLException e) {
            System.out.println("Error HistorialDAO.buscarPorPaciente: " + e.getMessage());
        }
