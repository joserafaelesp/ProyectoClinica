...
public class GravedadenfermedadDAO extends BaseDAO {
    ...
    public boolean insertar(Gravedadenfermedad g) {
        return ejecutar(
            "INSERT INTO GRAVEDAD_ENFERMEDAD (Id_Gravedad,Gravedad) VALUES (?,?)",
            g.getIdGravedad(),
            g.getGravedad()
        );
    }
    ...
    public ArrayList<Gravedadenfermedad> listarTodos() {
        ...
        try (
            ...
            ResultSet rs = st.executeQuery(
                "SELECT Id_Gravedad,Gravedad FROM GRAVEDAD_ENFERMEDAD ORDER BY Gravedad"
            )
        ) {
            ...
            System.out.println("Error GravedadDAO.listarTodos: " + e.getMessage());
        }
    ...
    public Gravedadenfermedad buscarPorId(String id) {
        ...
        try (
            ...
            System.out.println("Error GravedadDAO.buscarPorId: " + e.getMessage());
        }
    ...
    public boolean eliminar(String id) {
        return ejecutar(
            "DELETE FROM GRAVEDAD_ENFERMEDAD WHERE Id_Gravedad=?",
            id
        );
    }
}